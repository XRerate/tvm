...
@register_object("meta_schedule.JSONParetoDatabase")
class JSONParetoDatabase(Database):
    ...
    def __init__(
        ...
        *,
        ...
        self.__init_handle_by_constructor__(
            _ffi_api.DatabaseJSONParetoDatabase,  # type: ignore # pylint: disable=no-member
            path_workload,
            path_tuning_record,
            allow_missing,
            module_equality,
