...
@register_object("meta_schedule.NSGAIISearch")
class NSGAIISearch(SearchStrategy):
    """
    NSGAII Search Strategy is a search strategy that uses the NSGAII algorithm to search the best schedule.
    ...
    def __init__(
        ...
        *,
        ...
        self.__init_handle_by_constructor__(
            _ffi_api.SearchStrategyNSGAIISearch,  # type: ignore # pylint: disable=no-member
            population_size,
            init_measured_ratio,
            init_min_unmeasured,
            max_fail_count,
